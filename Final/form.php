...
<html>
    ...
    <body>
        <div class="container">
           ...
           <div class="title">
                <h2>Step 3: Privacy Risk Analysis</h2>
		</div>
            <div class="title">
                <p>In this step, we kindly ask you to evaluate each of the following identified privacy risks in terms of likelihood to be faced within your project and severity:</p>
            </div>

            <div class="links">
                <a href="form.php?form=1">
                    <p><b>Excessive Collection of Data</b></p>
                    <img src="collection.jpg" height="130"/>
                </a>
                <a href="form.php?form=2">
                    <p><b>Data Repurposing</b></p>
                    <img src="repurposing.jpg" height="130"/>
                </a>
                <a href="form.php?form=3">
                    <p><b>Data Sharing</b></p>
                    <img src="sharing.png" height="130"/>
                </a>
				<a href="form.php?form=4">
                    <p><b>Unauthorized Access</b></p>
                    <img src="unauthorized.png" height="130"/>
                </a>
				<a href="form.php?form=5">
                    <p><b>Data Manipulation</b></p>
                    <img src="manipulation.png" height="130"/>
                </a>
            </div>
			 </div>
...
<?php } else if(isset($_GET['form']) && $_GET['form'] == 4){ ?>
<!DOCTYPE html>
<html>
    <head>
        <title>Data Processing</title>
...
<?php } else if(isset($_GET['form']) && $_GET['form'] == 5){ ?>
<!DOCTYPE html>
<html>
    <head>
        <title>Data Processing</title>
