		...
		<div class="col-md-6 mt-3 pt-2 align-self-center border-reg">
			...
			<form method="POST" action="<?php echo $_SERVER['PHP_SELF'];?>">
                <div class="form-group row">
					...
					<div class="col-sm-9">
					<input type="text" name="first_name" placeholder="Dana" class="form-control" value="<?php echo ($valFirstName??'')?>">
				</div></div>
                <div class="form-group row">
					<label for="email" class="col-sm-3 col-form-label">Last Name:</label>
					<div class="col-sm-9">
					<input type="text" name="last_name" placeholder="Naous" class="form-control" value="<?php echo ($valLastName??'')?>">
				</div></div>
				<div class="form-group row">
					<label for="email" class="col-sm-3 col-form-label">Company:</label>
					<div class="col-sm-9">
					<input type="text" name="company" placeholder="UNIL" class="form-control" value="<?php echo ($valLastCompany??'')?>">
				</div></div>
				<div class="form-group row">
					<label for="email" class="col-sm-3 col-form-label">Role:</label>
					<div class="col-sm-9">
					<input type="text" name="role" placeholder="Researcher" class="form-control" value="<?php echo ($valLastRole??'')?>">
				</div></div>
                <div class="form-group row">
				...
				<div class="form-group row">
					...
					<div class="col-sm-9">
					<input type="text" name="phone" placeholder="+4177777777" class="form-control" value="<?php echo ($valLastPhone??'')?>">
				</div></div>

				<button type="submit" name="submit" class="btn btn-dark btn-lg btn-block">Save</button>
				<button type="submit" name="submit" class="btn btn-dark btn-lg btn-block">Cancel</button>
				</div>
			</form>
				<div class="row h-100 mt-5 justify-content-center align-items-center">
		</div>
